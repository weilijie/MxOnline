...
(function($) {
	...
	Canvas.prototype.resize = function(width, height) {
		...
		if (this.width != width) {
			...
			element.freestyle.width = width + "px";
			this.width = width;
		}

		if (this.height != height) {
			element.height = height * pixelRatio;
			element.freestyle.height = height + "px";
			this.height = height;
		}
	...
	Canvas.prototype.getTextInfo = function(layer, text, font, angle) {
		...
		if (typeof font === "object") {
			textStyle = font.freestyle + " " + font.variant + " " + font.weight + " " + font.size + "px/" + font.lineHeight + "px " + font.family;
		} else {
			textStyle = font;
		}
